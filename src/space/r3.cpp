...
bool R3::PointInSpheres(const R3Point &p) const {
...
Line R3::FormBridge(const R3Point &v0, const R3Point &v1) const {
  Line line{};
  line.p0 = v0;
  line.p1 = v1;
...
std::tuple<R3Point, Line> R3::Steer(const R3Point &v0, const R3Point &v1, double eta) const {
...
std::array<BoundingBoxIntervals, 3> R3::BoundingBox(const R3Point &p, double max_distance) const {
